...
printf("\nSending frames:\n"); 
scanf("%d",&ack);
printf("Enter frame number with no acks :%d",ack); 
if(ack == 0)
{
...
# OUTPUT
![WhatsApp Image 2025-11-18 at 18 27 19_75ff619e](https://github.com/user-attachments/assets/262d00d0-30b2-4eb9-874d-ad90afa9a4ff)
